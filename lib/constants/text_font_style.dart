...
//Initialising Constractor
  ...
  static final headline62w600c1C1C1CStylePlayfairDisplay =
  ...
  static final headline16w500c799021StyleNunito = GoogleFonts.nunito(
    color: AppColors.c799021,
    fontSize: 16.sp,
    fontStyle: FontStyle.italic,
    fontWeight: FontWeight.w500,
  );
  static final headline16w500c799021StyleNunitoNormal = GoogleFonts.nunito(
    color: AppColors.c727175,
    fontSize: 16.sp,
    fontStyle: FontStyle.italic,
    fontWeight: FontWeight.w700,
  );
  static final headline16w600c799021StyleNunito = GoogleFonts.nunito(
    color: AppColors.c799021,
    fontSize: 16.sp,
    fontStyle: FontStyle.italic,
    fontWeight: FontWeight.w600,
  );
  static final headline20w400c727175StyleNunito = GoogleFonts.nunito(
    color: AppColors.c727175,
    fontSize: 20.sp,
    // fontStyle: FontStyle.italic,
    fontWeight: FontWeight.w400,
  );
  static final headline24w600cC1C1C1StyleNunito = GoogleFonts.nunito(
    color: AppColors.c1C1C1C,
    fontSize: 24.sp,
    fontWeight: FontWeight.w600,
  );
  static final headline18w400cC1C1C1StyleArial = TextStyle(
    color: AppColors.c1C1C1C,
    fontSize: 16.sp,
    fontWeight: FontWeight.w400,
  );
